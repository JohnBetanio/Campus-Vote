...
Route::prefix('voter')->group(function () {
    ...
    Route::middleware('guest:voter')->group(function () {
        ...
        Route::post('login', [VoterAuthController::class, 'login'])->middleware('throttle:10,1');

        // Google OAuth Routes
        Route::get('auth/google', [GoogleAuthController::class, 'redirect'])
            ->name('voter.google.redirect')
            ->middleware('throttle:10,1');
        Route::get('auth/google/callback', [GoogleAuthController::class, 'callback'])
            ->name('voter.google.callback')
            ->middleware('throttle:10,1');
...
Route::prefix('voter')->middleware(['auth:voter'])->group(function () {
    ...
    Route::get('voting-confirmation', [VotingController::class, 'votingConfirmation'])->name('voter.voting.confirmation');
    ...
    // Voter profile edit/update
    Route::get('profile/edit', [VotingController::class, 'editProfile'])->name('voter.profile.edit');
    ...
    Route::prefix('api')->group(function () {
        ...
        Route::get('election/{election}/results', [ElectionStatusController::class, 'electionResults'])->name('voter.api.election.results');
