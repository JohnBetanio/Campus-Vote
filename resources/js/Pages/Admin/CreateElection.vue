<template>
    <DashboardLayout
        ...
        page-subtitle="Set up a new election with positions and candidates"
    >
        ...
        <form
            @submit.prevent="
                form.post(urls.admin?.elections_store || '/admin/elections')
            "
        >
            <div class="election-form">
                <div class="section-card">
                    <h2 class="section-header">
                        <FileText class="section-header-icon" :size="20" />
                        Election Details
                    </h2>
                    <div class="form-group">
                        ...
                        <input
                            ...
                            required
                        />
                        <p v-if="form.errors.title" class="form-error">
                            {{ form.errors.title }}
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="candidates-section">
                        ...
                        <div
                            v-for="(cand, cIdx) in position.candidates"
                            :key="cIdx"
                            class="candidate-input-group"
                        >
                            <input
                                v-model="position.candidates[cIdx]"
                                type="text"
                                class="form-control"
                            ...
                            <button
                                type="button"
                                class="btn btn-danger btn-sm"
                                @click="removeCandidate(index, cIdx)"
                            >
                                <X :size="14" />
                                Delete
                            </button>
                        ...
                        >
                            <Plus class="inline-block mr-2" :size="14" />
                            Add Candidate
                        </button>
                    </div>
                </div>
                ...
                <div style="text-align: center; margin-bottom: 20px">
                    <button type="button" class="btn-add" @click="addPosition">
                ...
                <div class="form-actions">
                    <Link
                        :href="
                            urls.admin?.elections_index || '/admin/elections'
                        "
...
const page = usePage();
const urls = page.props.urls?.admin ? page.props.urls : { admin: {} };
