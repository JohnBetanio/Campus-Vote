    ...
    >
            ...
            >
                ...
                <div class="announcement-actions">
                    ...
                    <button
                        ...
                        @click="confirmDelete(announcement.destroy_url)"
                    >
        ...
        >
            <div class="modal">
                ...
                <form
                    @submit.prevent="
                        createForm.post(urls.admin.announcements_store)
                    "
                >
...
import { Bell, Plus, Edit, Trash2, Clock } from 'lucide-vue-next';
...
watch(showEditModal, (v) => {
    if (!v) editingAnnouncement.value = null;
});
