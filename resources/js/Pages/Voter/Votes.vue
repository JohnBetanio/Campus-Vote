<template>
    <DashboardLayout
        page-title="Your Vote History"
        page-subtitle="Review all your submitted votes across past elections."
    >
        <div class="votes-header">
            ...
            <p class="votes-header-subtitle">
                Review all your submitted votes across all elections
            </p>
        </div>

        <template v-if="votesByElection.length">
            <div
                v-for="item in votesByElection"
                :key="item.election.id"
                class="election-votes-group"
            >
                ...
                <div class="votes-grid">
                    <div
                        v-for="(positionVotes, positionName) in item.votes"
                        :key="positionName"
                    >
                        <div
                            v-for="(vote, vIdx) in positionVotes"
                            :key="vIdx"
                            class="vote-card"
                        >
                ...
                <div class="votes-summary">
                    <strong>{{ item.positions_count }}</strong> Position(s) •
                    <strong>{{ item.votes_count }}</strong> Vote(s) Cast
                </div>
            </div>
        </template>
        ...
        <div v-else class="empty-state-container">
            ...
            <p class="empty-state-text">
                You haven't cast any votes yet. Participate in active elections
                to see your voting history here.
            </p>
            <Link
